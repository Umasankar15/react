      ...
      for (var root$29 = firstScheduledRoot; null !== root$29; ) {
        if (!onlyLegacy)
          if (0 !== syncTransitionLanes) {
            var pendingLanes = root$29.pendingLanes;
            if (0 === pendingLanes) var JSCompiler_inline_result = 0;
            else {
              var suspendedLanes = root$29.suspendedLanes,
                pingedLanes = root$29.pingedLanes;
            ...
            0 !== JSCompiler_inline_result &&
              ...
              performSyncWorkOnRoot(root$29, JSCompiler_inline_result));
          } else
            (JSCompiler_inline_result = workInProgressRootRenderLanes),
              (JSCompiler_inline_result = getNextLanes(
                root$29,
                root$29 === workInProgressRoot ? JSCompiler_inline_result : 0,
                null !== root$29.cancelPendingCommit ||
                  -1 !== root$29.timeoutHandle
              )),
              0 === (JSCompiler_inline_result & 3) ||
                checkIfRootIsPrerendering(root$29, JSCompiler_inline_result) ||
                ((didPerformSomeWork = !0),
                performSyncWorkOnRoot(root$29, JSCompiler_inline_result));
...
function pushRootMarkerInstance(workInProgress) {
  if (enableTransitionTracing) {
    ...
    null !== transitions &&
      transitions.forEach(function (transition) {
        if (!root$94.incompleteTransitions.has(transition)) {
          var markerInstance = {
            tag: 0,
          ...
          root$94.incompleteTransitions.set(transition, markerInstance);
        }
      });
    var markerInstances = [];
      ...
      do {
        if ((updateQueue.tag & flags) === flags) {
          ...
          if (enableUseResourceEffectHook) {
            ...
            var create$164 = updateQueue.create,
              inst$165 = updateQueue.inst;
            lastEffect = create$164();
            inst$165.destroy = lastEffect;
          }
          enableSchedulingProfiler &&
            (0 !== (flags & 8)
              ? enableSchedulingProfiler &&
...
function commitDeletionEffectsOnFiber(
  ...
  switch (deletedFiber.tag) {
    ...
    case 6:
      ...
      var prevHostParentIsContainer$179 = hostParentIsContainer;
      hostParent = null;
      recursivelyTraverseDeletionEffects(
        finishedRoot,
        nearestMountedAncestor,
      ...
      hostParentIsContainer = prevHostParentIsContainer$179;
      if (null !== hostParent)
        if (hostParentIsContainer)
          try {
            switch (hostParent.nodeType) {
              case 8:
                prevHostParent = hostParent.parentNode;
                break;
              case 9:
                prevHostParent = hostParent.body;
                break;
              default:
                prevHostParent =
            ...
            prevHostParent.removeChild(deletedFiber.stateNode);
          } catch (error) {
            captureCommitPhaseError(
              deletedFiber,
              nearestMountedAncestor,
    ...
    try {
      ...
      switch (JSCompiler_inline_result.tag) {
        case 27:
          ...
          break;
        case 5:
          var parent$171 = JSCompiler_inline_result.stateNode;
          JSCompiler_inline_result.flags & 32 &&
            (setTextContent(parent$171, ""),
            (JSCompiler_inline_result.flags &= -33));
          var before$172 = getHostSibling(finishedWork);
          insertOrAppendPlacementNode(finishedWork, before$172, parent$171);
          break;
        case 3:
        case 4:
          var parent$173 = JSCompiler_inline_result.stateNode.containerInfo,
...
function getLaneLabelMap() {
  if (enableSchedulingProfiler) {
    for (
      var map = new Map(), lane = 1, index$217 = 0;
      31 > index$217;
      index$217++
    ) {
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_1672 = "oninput" in document;
    if (!isSupported$jscomp$inline_1672) {
      var element$jscomp$inline_1673 = document.createElement("div");
      element$jscomp$inline_1673.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1672 =
        "function" === typeof element$jscomp$inline_1673.oninput;
    }
    JSCompiler_inline_result$jscomp$372 = isSupported$jscomp$inline_1672;
...
for (
  var i$jscomp$inline_1713 = 0;
  i$jscomp$inline_1713 < simpleEventPluginEvents.length;
  i$jscomp$inline_1713++
) {
  var eventName$jscomp$inline_1714 =
      simpleEventPluginEvents[i$jscomp$inline_1713],
    domEventName$jscomp$inline_1715 =
      eventName$jscomp$inline_1714.toLowerCase(),
    capitalizedEvent$jscomp$inline_1716 =
      eventName$jscomp$inline_1714[0].toUpperCase() +
      eventName$jscomp$inline_1714.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1715,
    "on" + capitalizedEvent$jscomp$inline_1716
  );
}
...
if (
  "19.1.0-www-modern-221f3002-20250130" !==
...
var internals$jscomp$inline_1888 = {
  bundleType: 0,
  version: "19.1.0-www-modern-221f3002-20250130",
  rendererPackageName: "react-dom",
  currentDispatcherRef: ReactSharedInternals,
  reconcilerVersion: "19.1.0-www-modern-221f3002-20250130"
};
enableSchedulingProfiler &&
  ((internals$jscomp$inline_1888.getLaneLabelMap = getLaneLabelMap),
  (internals$jscomp$inline_1888.injectProfilingHooks = injectProfilingHooks));
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2371 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2371.isDisabled &&
    hook$jscomp$inline_2371.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2371.inject(
        internals$jscomp$inline_1888
      )),
        (injectedHook = hook$jscomp$inline_2371);
    } catch (err) {}
}
...
exports.version = "19.1.0-www-modern-221f3002-20250130";
"undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ &&
  "function" ===
