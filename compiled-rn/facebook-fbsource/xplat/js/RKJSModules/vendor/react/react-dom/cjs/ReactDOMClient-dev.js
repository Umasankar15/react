 ...
 * @nolint
 * @preventMunge
 * @generated SignedSource<<baf4ef129bb394c3de7bf4e9231d23e8>>
 */
...
__DEV__ &&
  (function () {
    ...
    function throwException(
              ...
              return (
                ...
                value === noopSuspenseyCommitThenable
                  ...
                  : ((sourceFiber = currentSourceFiber.updateQueue),
                    ...
                    currentSourceFiber.mode & ConcurrentMode &&
                      attachPingListener(root, value, rootRenderLanes)),
                !1
              );
            case 22:
              if (currentSourceFiber.mode & ConcurrentMode)
                return (
      ...
      if (isHydrating && sourceFiber.mode & ConcurrentMode)
        return (
          (didSuspendOrErrorDEV = !0),
          (currentSourceFiber = suspenseHandlerStackCursor.current),
          null !== currentSourceFiber
      ...
      if (null !== ref)
        if ("function" === typeof refCleanup)
          ...
          try {
            ...
            captureCommitPhaseError(current, nearestMountedAncestor, error$22);
          }
      ...
      if ("function" === typeof type)
        ...
        a: switch (type) {
          ...
          case REACT_STRICT_MODE_TYPE:
            ...
            (mode & ConcurrentMode) !== NoMode && (mode |= StrictEffectsMode);
            break;
          case REACT_PROFILER_TYPE:
            return (
              (type = pendingProps),
      ...
      switch (workInProgress.tag) {
        ...
        case 23:
          return (
            ...
            newProps && (workInProgress.mode & ConcurrentMode) !== NoMode
    ...
    function requestUpdateLane(fiber) {
      if ((fiber.mode & ConcurrentMode) === NoMode) return 2;
      if (
    ...
    function throwAndUnwindWorkLoop(
      ...
      try {
        ...
        if (null !== returnFiber)
          throw ((workInProgress = returnFiber), error$44);
        workInProgressRootExitStatus = RootFatalErrored;
        logUncaughtError(
          root,
          createCapturedValueAtFiber(thrownValue, root.current)
    ...
    function retryTimedOutBoundary(boundaryFiber, retryLane) {
      0 === retryLane &&
        (retryLane =
          (boundaryFiber.mode & ConcurrentMode) === NoMode
            ? 2
            : claimNextRetryLane());
    ...
    function updateContainerSync(
      ...
      0 === container.tag && flushPendingEffects();
      updateContainerImpl(
        container.current,
        2,
        element,
    ...
    var index$jscomp$0 = -1,
      contextStackCursor$1 = createCursor(null),
    ...
    (function () {
      ...
      if ("19.1.0-native-fb-221f3002-20250130" !== isomorphicReactPackageVersion)
        throw Error(
          'Incompatible React versions: The "react" and "react-dom" packages must have the exact same version. Instead got:\n  - react:      ' +
            (isomorphicReactPackageVersion +
              "\n  - react-dom:  19.1.0-native-fb-221f3002-20250130\nLearn more: https://react.dev/warnings/version-mismatch")
        );
    })();
    ("function" === typeof Map &&
      null != Map.prototype &&
